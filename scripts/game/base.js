...
var Dialog	= {	
	info: function(ID){
		return Dialog.open('game.php?page=information&id='+ID, 590, (ID > 600 && ID < 800 || ID > 900 && ID < 930) ? 310 : ((ID > 100 && ID < 200) ? 400 : 720));
	},
	...
	PlanetAction: function() {
		return Dialog.open('game.php?page=overview&mode=actions', 500, 300);
	},
