...
//			$GLOBALS['DATABASE']->query("UPDATE ".USERS." SET `authattack` = '0' WHERE `universe` = '".Universe::getEmulated()."';");
	...
	$template->assign_vars(array(
        ...
        'se_coinpot_start'              => $LNG['se_coinpot_start'],
        'se_coinpot_increase'           => $LNG['se_coinpot_increase'],
        'se_coin_amount_val'                => $LNG['se_coin_amount'],
        'se_coin_update_val'                => $LNG['se_coin_update'],
        'se_coinpot_start_val'              => $LNG['se_coinpot_start'],
        'se_coinpot_increase_val'           => $LNG['se_coinpot_increase'],
        'se_referral_earn'              => $LNG['se_referral_earn'],
        'se_coinpot_wait_minutes'       => $LNG['se_coinpot_wait_minutes'],
        'se_coinpot_random_minutes'     => $LNG['se_coinpot_random_minutes'],
		'CoinAmountVal'                 => $CoinAmountVal,
		'CoinUpdateVal'                 => $CoinUpdateVal,
		'coinpot_start'                 => $config->coinpot_start,
		'coinpot_increase'              => $config->coinpot_increase,
