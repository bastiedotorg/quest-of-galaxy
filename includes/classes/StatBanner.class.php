...
class StatBanner
{
    ...
    public function CreateUTF8Banner($data)
    {
        ...
        imagettftext($image, 16, 0, 250, 31, $shadow, $Font, $config->game_name);
        imagettftext($image, 16, 0, 250, 30, $color, $Font, $config->game_name);
